...
#define DEBUG 0
#define ARGC 5
#define IN_FILE "c_input_file.txt"
#define OUT_FILE "c_output_file.txt"
...
static PyObject* fit(PyObject *self, PyObject *args){
    ...
    if(!PyArg_ParseTuple(args, "sds", &k, &eps, &max_iter)){
        return  NULL;
    }
...
int kmeans(int argc, char *argv[], double eps) {
    int k = 0;
    int max_iter = 0;
